...
#                    print("learning rate is ", optimizer.param_groups[0]["lr"])
            ...
            # neptune.log_metric('Train loss', epoch+1, epoch_loss)
            # neptune.log_metric('Learning rate', epoch+1, optimizer.param_groups[1]["lr"])
            # neptune.log_metric('Satellite Acc', epoch+1, epoch_acc)
            # neptune.log_metric('Street Acc', epoch+1, epoch_acc2)
