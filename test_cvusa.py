...
from image_folder import ImageFolder_iaa
...
if opt.multi:
    ...
    if opt.iaa:
        ...
        image_datasets = {x: datasets.ImageFolder(os.path.join(data_dir, x), data_transforms) for x in
                          ['satellite']}
        image_datasets['street'] = ImageFolder_iaa(os.path.join(data_dir, 'street'),
                                                   transform=data_transforms_iaa,
                                                   iaa_transform=iaa_transform)
